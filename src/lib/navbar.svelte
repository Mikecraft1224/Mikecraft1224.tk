...
>
	...
	<div class="text-sm gap-3 md:text-lg md:gap-6 flex place-content-end p-3 py-4">
		<NavbarEntry path="/" name="HOME">
			<svg slot="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=20 height=20>
		...
		<Dropdown name="PROJEKTE">
			<svg slot="img1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=20 height=20>
        <!--! Font Awesome Free 6.0.0-beta3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2021 Fonticons, Inc.-->
        <path 
      ...
      <svg slot="img2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=20 height=20>
        <!--! Font Awesome Free 6.0.0-beta3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2021 Fonticons, Inc.-->
        <path 
        ...
        />
			...
			<div slot="dropcontent">
				<NavbarEntry path="/ " name="Messenger (coming soon)">
					<svg slot="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width=20 height=20>
            <!--! Font Awesome Free 6.0.0-beta3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2021 Fonticons, Inc.-->
            <path 
		...
		<NavbarEntry path="/impressum" name="IMPRESSUM">
			<svg slot="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=20 height=20>
        <!--! Font Awesome Free 6.0.0-beta3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2021 Fonticons, Inc.-->
        <path 
